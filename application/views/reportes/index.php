						...
						<div class="card-body">
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="agencias" role="tabpanel" aria-labelledby="agencias-tab">
									<div id="reporteMapaAgencias" style="width: 100%; height:600px;"></div>
								</div>
								<div class="tab-pane fade" id="cajeros" role="tabpanel" aria-labelledby="cajeros-tab">
									<div id="reporteMapaCajeros" style="width: 100%; height:600px;"></div>
								</div>
								...
								<div class="tab-pane fade" id="general" role="tabpanel" aria-labelledby="general-tab">
									<div id="reporteMapaGeneral" style="width: 100%; height:600px;"></div>
								</div>
							</div>
						</div>
					</div>
